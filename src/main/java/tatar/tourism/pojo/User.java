 ...
 */
 public abstract class User {
    ...
    public void setPassword(String password) throws NoSuchAlgorithmException //throws UnsupportedEncodingException, NoSuchAlgorithmException
    {
    ...
    public abstract boolean isJUser();
